                    ...
                    <div class="card shadow h-100 border-top border-4 border-primary">
                      <div class="card-body bg-light">
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <div class="text-xs fw-bold text-center text-uppercase mb-1 text-primary">Production Projects</div>
                  ...
                  <div class="col-xl-4 col-md-6 mb-2">
                    <div class="card shadow h-100 border-top border-4 border-primary">
                      <div class="card-body bg-light">
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <div class="text-xs fw-bold text-center text-uppercase mb-1 text-success"> Open Projects</div>
                            <div class="h4 mb-0 fw-bold text-center justify-content-around d-flex text-dark">
                              <?php if (in_array('PC&A Summary', $Category) && $summaryDetails['result']['data']['Total_Projects_PCndA'] != 0) {
                  ...
                  <div class="col-xl-4 col-md-6 mb-2">
                    <div class="card shadow h-100 border-top border-4 border-primary">
                      <div class="card-body bg-light">
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <div class="text-xs fw-bold text-center text-uppercase mb-1 text-warning">On hold Projects</div>
                            <div class="h4 mb-0 fw-bold text-center justify-content-around d-flex text-dark">
                              <?php
                              if (in_array('PC&A Summary', $Category) && $summaryDetails['result']['data']['Total_Projects_PCndA'] != 0) {
                  ...
                  <div class="col-xl-4 col-md-6 mb-2">
                    <div class="card shadow h-100 border-top border-4 border-primary">
                      <div class="card-body bg-light">
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <div class="text-xs fw-bold text-center text-uppercase mb-1 text-danger">Cancelled Projects</div>
                            <div class="h4 mb-0 fw-bold text-center justify-content-around d-flex text-dark">
                              <?php if (in_array('PC&A Summary', $Category) && $summaryDetails['result']['data']['Total_Projects_PCndA'] != 0) {
                    ...
                    <div class="col-xl-6 col-md-6 mb-2">
                      <div class="card shadow h-100 border-top border-4 border-primary">
                        <div class="card-body bg-light">
                          <div class="row no-gutters align-items-center">
                            <div class="col p-1">
                              <div class="text-xs fw-bold text-uppercase mb-1 text-success">Units Delivered</div>
                    ...
                    <div class="col-xl-6 col-md-6 mb-2">
                      <div class="card shadow h-100 border-top border-4 border-primary">
                        <div class="card-body bg-light">
                          <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                              <div class="text-xs fw-bold text-uppercase mb-2 text-primary">Units in production</div>
                              <div class="h5 mb-0 mr-3 fw-bold text-dark">
                                <?php
            ...
            <div class="row">
              ...
              <div class="col-xl-12 col-md-12 mb-2">
                <div class="card shadow h-100 border-primary mt-0">
                  ...
                  <div class="card-body bg-light pt-0 widgets_bg1">
...
<script>
  ...
  function initMap() {
    ...
    var mapOptions = {
        center: {
          lat: 18.5937,  // Central latitude of India
          lng: 74.9629   // Central longitude of India
        },
        zoom: 4,        // Set a zoom level to ensure the whole country and surrounding areas are visible
        minZoom: 4.5,     // Minimum zoom level to keep India and surrounding areas visible
        maxZoom: 12,    // Maximum zoom level for detailed view
        mapTypeId: 'terrain', // Map type
