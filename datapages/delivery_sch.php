...
<div id="dsSec">
  ...
  $deliveryDetails = getDeliveryScheduleData();
  // print_r("get Deli " . json_encode($deliveryDetails));
  $deliveryDetails = $deliveryDetails["result"]["data"];
  // if (isset($deliveryDetails['notYetDelivered']['data']) && $deliveryDetails['notYetDelivered']['data'] != null || isset($deliveryDetails['delivered']['data']) && $deliveryDetails['delivered']['data'] != null) 
  // {
  //   $totalDeliveredCount = 0;
  //   $totalNotDeliveredCount = 0;
  //   if(isset($deliveryDetails['notYetDelivered']['data'])){
  //     $totalDeliveredCount = count($deliveryDetails['notYetDelivered']['data']);
  //   }
  //   if(isset($deliveryDetails['delivered']['data'])){
  //     $totalNotDeliveredCount = count($deliveryDetails['delivered']['data']);
  //   }
        ...
        <div class="card mb-4 mt-2 tablecard">
          ...
          <div class="card-header pt-3">
            <div class="row">
              ...
              <div class="col-md-6 d-flex justify-content-end">
                <b>Total Records : <span><?php echo $deliveryDetails["totalRecordCount"] ?? 0 ?></span></b>
              </div>
            </div>
          </div>
          ...
          <div class="card-body pt-1 p-0">
            ...
            <?php if ($summaryDetails['result']['data']['Units_Delivered_EA'] != 0 || $summaryDetails['result']['data']['Units_Delivered_KG'] != 0 || $summaryDetails['result']['data']['Units_Delivered_MT'] != 0) { ?>
                          ...
                          <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 fw-bold text-light">
                              <?php if (isset($summaryDetails['result']['data']['Units_Delivered_EA']) && $summaryDetails['result']['data']['Units_Delivered_EA'] != 0) : ?>
                                <span class="pd_br"><?php echo $summaryDetails['result']['data']['Units_Delivered_EA'] ?? "-" ?> <small class="fs13"><?php echo "EA" ?></small></span>
                              <?php endif ?>
                              <?php if (isset($summaryDetails['result']['data']['Units_Delivered_KG']) && $summaryDetails['result']['data']['Units_Delivered_KG'] != 0) : ?>
                                <span class="pd_br"><?php echo $summaryDetails['result']['data']['Units_Delivered_KG'] ?? "-" ?> <small class="fs13"><?php echo "kg" ?></small></span>
                              <?php endif ?>
                              <?php if (isset($summaryDetails['result']['data']['Units_Delivered_MT']) && $summaryDetails['result']['data']['Units_Delivered_MT'] != 0) : ?>
                                <span class="pd_br"><?php echo $summaryDetails['result']['data']['Units_Delivered_MT'] ?? "-" ?> <small class="fs13"><?php echo "Mts" ?></small></span>
                              <?php endif ?>
                            </div>
                      ...
                      <div class="card-body m-0 align-item-center justify-content-center d-flex">
                        <div class="row no-gutters align-items-center w-100">
                          <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 fw-bold text-light">
                              <?php if (isset($summaryDetails['result']['data']['Units_Not_Delivered_EA']) && $summaryDetails['result']['data']['Units_Not_Delivered_EA'] != 0) : ?>
                                <span class="pd_br"><?php echo $summaryDetails['result']['data']['Units_Not_Delivered_EA'] ?? "-" ?> <small class="fs13"><?php echo "EA" ?></small></span>
                              <?php endif ?>
                              <?php if (isset($summaryDetails['result']['data']['Units_Not_Delivered_KG']) && $summaryDetails['result']['data']['Units_Not_Delivered_KG'] != 0) : ?>
                                <span class="pd_br"><?php echo $summaryDetails['result']['data']['Units_Not_Delivered_KG'] ?? "-" ?> <small class="fs13"><?php echo "kg" ?></small></span>
                              <?php endif ?>
                              <?php if (isset($summaryDetails['result']['data']['Units_Not_Delivered_MT']) && $summaryDetails['result']['data']['Units_Not_Delivered_MT'] != 0) : ?>
                                <span class="pd_br"><?php echo $summaryDetails['result']['data']['Units_Not_Delivered_MT']  ?? "-" ?> <small class="fs13"><?php echo "Mts" ?></small></span>
                              <?php endif ?>
                            </div>
                            <div class="mt-2 mb-0 text-dark text-xs">
              ...
              <?php if ($summaryDetails['result']['data']['Avg_Acceptance_Rate'] != null && $summaryDetails['result']['data']['Avg_Acceptance_Rate'] != 0) { ?>
                      ...
                      <div class="card-body m-0 align-item-center justify-content-center d-flex">
                          <div class="row no-gutters align-items-center w-100">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 fw-bold text-light"><?php echo $summaryDetails['result']['data']['Avg_Acceptance_Rate'] * 100 ?> %</div>
              ...
              <div class="table table-responsive">
                <?php if ((isset($deliveryDetails['delivered']) && count($deliveryDetails['delivered']) > 0 || isset($deliveryDetails['notYetDelivered']) && count($deliveryDetails['notYetDelivered']) > 0)) { ?>
                  <table style="width:100%" class="table table-striped" id="d_sch_combined">
                    ...
                    <tbody>
                      ...
                      <?php
                      if (isset($deliveryDetails['notYetDelivered']) && count($deliveryDetails['notYetDelivered']) > 0) {
                        foreach ($deliveryDetails['notYetDelivered'] as $record) {
                          if (isset($record)) { ?>
                            <tr>
                              <td></td>
                            ...
                            <td><?php echo htmlspecialchars(isset($record['Actual_Date_of_Delivery']) && !empty($record['Actual_Date_of_Delivery']) ? $record['Actual_Date_of_Delivery'] : "-"); ?></td>
                              ...
                              ?>
                                <td>
                                  <a href='<?php echo $Shipping_Document; ?>' download><img src='../images/filedlod.png' width='35px'></a>
                                </td>
                              <?php } else { ?>
                                <td>-</td>
                              <?php } ?>
                      ...
                      <?php if (isset($deliveryDetails['delivered']) && count($deliveryDetails['delivered']) > 0) { ?>
                        <tr class="table-secondary">
                          <td colspan="16"><strong>Delivered</strong></td>
                        </tr>
                        <?php foreach ($deliveryDetails['delivered'] as $record) { ?>
                          <tr>
                            <td></td>
                            <td><?php echo htmlspecialchars(isset($record['Project_Number']) && !empty($record['Project_Number']) ? $record['Project_Number'] : "-"); ?></td>
                            <td><?php echo htmlspecialchars(isset($record['Customer_PO1']['PO_Number']) && !empty($record['Customer_PO1']['PO_Number']) ? $record['Customer_PO1']['PO_Number'] : "-"); ?></td>
                            ...
                            if ($Shipping_Document != null && $Shipping_Document != "") {
                            ?>
                              <td class="text-center"><a href='<?php echo $Shipping_Document; ?>' download><img src='../images/filedlod.png' width='35px'></a></td>
                            <?php } else { ?>
                              <td>-</td>
                            <?php } ?>
                            <td><?php echo htmlspecialchars(isset($record['Tracking_Number']) && !empty($record['Tracking_Number']) ? $record['Tracking_Number'] : "-"); ?></td>
