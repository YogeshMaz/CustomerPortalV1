            ...
            <div class="col-md-12 col-sm-8">
                <div class="card mb-4 mt-2 tablecard">
                    ...
                    <div class="card-header pt-3">
                      <div class="row">
                        <div class="col-md-6">
                          <h5 class="my-1 fw-bold text-primary">Invoices List</h5>
                        </div>
                        ...
                        <div class="table table-responsive">
                            ...
                            <table style="width:100%" class="table table-striped" id="invoice_data">
                                ...
                                <tbody>
                                    ...
                                    <?php $url = "https://customerportal.machinemaze.com/datapages/invoices_report.php?ID=" . htmlspecialchars($record['ID']); ?>
                                    <tr>
                                        <td></td>
                                        ...
                                        ?>
                                        <td class="text-center"><a href='<?php echo $Debit_Note_Upload; ?>' download><img src="../images/filedlod.png" width="35px"></a></td>
                                        <?php 
                                        } else {
                                        ?>
