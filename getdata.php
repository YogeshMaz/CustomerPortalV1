...
function getCustomAPIData($functionName, $userEmail){
    ...
    curl_setopt_array($curl, array(
    CURLOPT_URL => 'https://www.zohoapis.in/creator/custom/arun.ramu_machinemaze/' . $functionName . '?email=' . $userEmail,
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => '',
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 0,
...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true) {
    ...
    $summaryResponse = getCustomAPIData('FetchSummaryDetails', $email);
...
function getYourPartnerData()
{
    ...
    $summaryResponse = getCustomAPIData('FetchSummaryDetails', $_SESSION['email']);
    $summaryDetails = json_decode($summaryResponse, true);
